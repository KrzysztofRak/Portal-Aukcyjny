    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td class="auto-style19"><strong>
                <asp:Label ID="TimeLeftLabel" runat="server" Style="color: #336699" Text="<%$ Resources:Do końca pozostało%>"></asp:Label>
            </strong>&nbsp;<asp:Label ID="TimeLeft" runat="server" Text="Label"></asp:Label>
                &nbsp;</td>
            <td colspan="2" class="auto-style3"><strong>
                <asp:Label ID="ItemsNumLabel" runat="server" Style="color: #336699" Text="<%$ Resources:Dostępnych sztuk%>"></asp:Label>
        ...
        <tr>
            ...
            <td class="auto-style19">
                <asp:Button ID="BtnCloseAuction" runat="server" Text="<%$ Resources:Zakończ aukcje%>" Width="186px" Height="31px" Visible="False" OnClick="BtnCloseAuction_Click" />
            </td>
        ...
        <tr>
            ...
            <td class="auto-style15"><strong>
                <asp:Label ID="BuyItNowLabel" runat="server" Style="color: #990000" Text="<%$ Resources:Cena kup teraz%>" Visible="False"></asp:Label>
            </strong>&nbsp;<asp:Label ID="BuyItNowPrice" runat="server" Text="Label" Visible="False"></asp:Label>
            </td>
            <td colspan="2" class="auto-style16">
                <asp:Button ID="BuyItNowBtn" runat="server" Text="<%$ Resources:Kup teraz%>" Width="129px" Height="31px" Visible="False" OnClick="BuyItNowBtn_Click" />
            </td>
        ...
        <tr>
            ...
            <td class="auto-style10" rowspan="6">
                ...
                <asp:Button ID="BidBtn" runat="server" Text="<%$ Resources:Licytuj%>" Width="125px" Height="31px" Visible="False" OnClick="BidBtn_Click" />
            </td>
        ...
        <tr>
            ...
            <td class="auto-style20">
                <strong>
                <asp:Label ID="BidLabel" runat="server" Style="color: #990000" Text="<%$ Resources:Najwyższa oferta%>" Visible="False"></asp:Label>
        ...
        <tr>
            ...
            <td class="auto-style20">
                <strong>
                <asp:Label ID="BidUsernameLabel" runat="server" Style="color: #990000" Text="<%$ Resources:Od użytkownika%>" Visible="False"></asp:Label>
            </strong>
        ...
        <tr>
            ...
            <td class="auto-style20">
                <strong>
                <asp:Label ID="Label10" runat="server" Style="color: #006600" Text="<%$ Resources:Wysyłka%>"></asp:Label>
        ...
        <tr>
            ...
            <td class="auto-style19">
                <strong>
                <asp:Label ID="Label12" runat="server" Style="color: #CC6600" Text="<%$ Resources:Sprzedający%>"></asp:Label>
            </strong>
        ...
        <tr>
            ...
            <td colspan="5" style="height: 22px"><strong>
                <asp:Label ID="Label11" runat="server" Style="font-size: large; color: #336699; text-decoration: underline;" Text="<%$ Resources:Opis przedmiotu%>"></asp:Label>
            </strong></td>
            <td style="height: 22px"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="height: 22px" colspan="5"><strong>
                <asp:Label ID="Label13" runat="server" Style="font-size: large; color: #336699; text-decoration: underline;" Text="<%$ Resources:Lista ofert%>"></asp:Label>
            </strong></td>
            <td style="height: 22px">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 30px; height: 22px"><strong>
                <asp:Label ID="Label14" runat="server" Style="font-size: large; color: #336699; text-decoration: underline;" Text="<%$ Resources:Komentarze%>"></asp:Label>
            </strong></td>
            <td style="width: 29px; height: 22px">&nbsp;</td>
            <td class="auto-style17">&nbsp;</td>
            <td class="auto-style18">&nbsp;</td>
        ...
        <tr>
            ...
            <td style="width: 304px; height: 22px"><strong>
                <asp:Label ID="LabelViews" runat="server" Text="<%$ Resources:Wyświetlenia%>"></asp:Label>
            </strong>
